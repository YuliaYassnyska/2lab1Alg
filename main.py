...
class Film:
    ...
    def __init__(self, name="NoName", durationInMinutes=0, numberOfReviewsImdb=0):
...
with open("input.txt") as file:
    ...
    films = [Film(*line.split(',')) for line in file.readlines()]
...
A = [s.durationInMinutes for s in films]
